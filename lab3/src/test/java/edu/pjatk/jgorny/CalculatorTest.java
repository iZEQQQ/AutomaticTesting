...
//        Assert
    ...
    @Test
    public void addingStrings_addingCorrectString_correctResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        String result = cal.addingStrings("cyk", "tak");

//        Assert
        assertEquals("cyktak", result);
    }

    @Test
    public void isEven_checkingIs10Even_correctResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        Boolean result = cal.isEven(10);
...
//        Assert
    ...
    @Test
    public void isEven_checkingIs1Even_uncorrectResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        Boolean result = cal.isEven(1);
...
//        Assert
    ...
    @Test
    public void timesThree_times3is9_correctResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        int result = cal.timesThree(3);
...
//        Assert
    ...
    @Test
    public void times10_times10is90_correctResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        int result = cal.times10(9);
...
//        Assert
    ...
    @Test
    public void sqrt_sqrtOf4_correctResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        double result = cal.sqrt(4);
...
//        Assert
    ...
    @Test
    public void timesNumber_3x3_correctResult() {
//        Prepare
        Calculator cal = new Calculator();

//        Execute
        double result = cal.timesNumber(3);
